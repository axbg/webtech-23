...
- [Seminar 6  - Definirea serverului back-end folosind Express](https://github.com/axbg/webtech-23/releases/tag/app-after-lab6)
- [Seminar 7  - Conectarea la baza de date, definirea entităților și utilizarea unui ORM (Sequelize)](https://github.com/axbg/webtech-23/releases/tag/app-after-lab7)
- [Seminar 8  - Adăugarea relațiilor dintre entități](https://github.com/axbg/webtech-23/releases/tag/app-after-lab8)
- [Seminar 9  - Definirea aplicației front-end și a request-urilor HTTP către back-end](https://github.com/axbg/webtech-23/releases/tag/app-after-lab9)
- [Seminar 10 - Stilizarea front-end-ului folosind CSS](https://github.com/axbg/webtech-23/releases/tag/app-after-lab-10)
- [Seminar 11 - Migrare front-end-ului la React](https://github.com/axbg/webtech-23/releases/tag/app-after-lab-11)
- [Seminar 12 - Integrarea Redux](https://github.com/axbg/webtech-23/releases/tag/app-after-lab-12)
- [Seminar 13 - Integrarea Material UI (versiune finală)](https://github.com/axbg/webtech-23/releases/tag/app-after-lab-13)
